...
describe('export uploads', () => {
  it('should be able to export uploads', async () => {
    //spy - monitorar que algo foi executado, mas não alterar o comportamento da função
    //stub - monitorar que algo foi executado e alterar o comportamento da função
    const uploadStub = vi
